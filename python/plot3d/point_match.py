...
def point_match(x:float, y:float, z:float, X2:jnp.ndarray, Y2:jnp.ndarray, Z2:jnp.ndarray, tol:float=1E-6):
    ...
    Args:
        ...
        X2 (jnp.ndarray): X(i,j,k)
        Y2 (jnp.ndarray): Y(i,j,k)
        Z2 (jnp.ndarray): Z(i,j,k)
